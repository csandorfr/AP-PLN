...
python pipeline_evaluation_rescore.py /net/isi-scratch/cynthia/CW007_SANDOR_Pipeline/network/all/semantic_sim_gene_all_hpo_mgi_sort.txt Julia_GTEx_corrected_0.4_sort /net/isi-backup/webber/code/cynthias/disease_specific_network_v4/data/frankdatasetnorm/gtex /net/isi-scratch/cynthia/CW007_SANDOR_Pipeline/network/all 0.11
