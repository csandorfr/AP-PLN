...
python pipeline_evaluation_rescore.py /net/isi-scratch/cynthia/CW007_SANDOR_Pipeline/network/all/semantic_sim_gene_all_hpo_mgi_sort.txt links_ensg_ho_10090_9ordered_filter_200.0_sort /net/isi-backup/webber/code/cynthias/disease_specific_network_v4/data/frankdatasetnorm/string /net/isi-scratch/cynthia/CW007_SANDOR_Pipeline/network/all 0.11
