...
python pipeline_evaluation_rescore.py /net/isi-scratch/cynthia/CW007_SANDOR_Pipeline/network/all/semantic_sim_gene_all_hpo_mgi_sort.txt goa_mouseho_mf_resg_av_ordered_filter_4.0_sort /net/isi-backup/webber/code/cynthias/disease_specific_network_v4/data/frankdatasetnorm/gomf /net/isi-scratch/cynthia/CW007_SANDOR_Pipeline/network/all 0.11
