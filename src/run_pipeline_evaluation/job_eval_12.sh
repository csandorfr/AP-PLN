...
python pipeline_evaluation_rescore.py /net/isi-scratch/cynthia/CW007_SANDOR_Pipeline/network/all/semantic_sim_gene_all_hpo_mgi_sort.txt Iacobuzio_2003_ordered_ord_filter_0.4_sort /net/isi-backup/webber/code/cynthias/disease_specific_network_v4/data/frankdatasetnorm/coexpression /net/isi-scratch/cynthia/CW007_SANDOR_Pipeline/network/all 0.11
